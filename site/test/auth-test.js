...
describe('Auth', function()
{
  ...
  {
    expect(Auth.generateAccessToken(43, 1517251117)).to.not.equal(Auth.generateAccessToken(43, 1517251119));
    expect(Auth.generateAccessToken(54, 1517251114)).to.not.equal(Auth.generateAccessToken(75, 1517251114));
    expect(Auth.generateAccessToken(43, -100000)).to.not.equal(Auth.generateAccessToken(43, 1517251117));
    expect(Auth.generateAccessToken(54, -1517251117)).to.not.equal(Auth.generateAccessToken(75, -1517251117));
  });

  it('validateAccessToken should return false for expired tokens', function()
  {
    expect(Auth.validateAccessToken(Auth.generateAccessToken(43, 0))).to.equal(false);
    expect(Auth.validateAccessToken(Auth.generateAccessToken(43, 1))).to.equal(false);
    expect(Auth.validateAccessToken(Auth.generateAccessToken(43, 1517251117))).to.equal(false);
    expect(Auth.validateAccessToken(Auth.generateAccessToken(43, -10))).to.equal(false);
    expect(Auth.validateAccessToken(Auth.generateAccessToken(43, -1517251117))).to.equal(false);
  });
  ...
  it('validateAccessToken should return true for valid tokens', function()
  {
    ...
    expect(Auth.validateAccessToken(Auth.generateAccessToken(43, curUnixTime + 1))).to.equal(true);
    expect(Auth.validateAccessToken(Auth.generateAccessToken(43, curUnixTime + (60 * 60)))).to.equal(true);
  });
